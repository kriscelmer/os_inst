...
echo "---> Installing neutron on compute3"
set -e
set -x
...
crudini --set /etc/neutron/plugins/ml2/linuxbridge_agent.ini vxlan local_ip 10.0.0.33
...
set +x
echo "---> Neutron on compute3 installed"
