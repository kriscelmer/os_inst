...
openstack endpoint create --region RegionOne volumev2 public 'http://10.0.0.11:8776/v2/%(project_id)s'
openstack endpoint create --region RegionOne volumev2 internal 'http://10.0.0.11:8776/v2/%(project_id)s'
openstack endpoint create --region RegionOne volumev2 admin 'http://10.0.0.11:8776/v2/%(project_id)s'
openstack endpoint create --region RegionOne volumev3 public 'http://10.0.0.11:8776/v3/%(project_id)s'
openstack endpoint create --region RegionOne volumev3 internal 'http://10.0.0.11:8776/v3/%(project_id)s'
openstack endpoint create --region RegionOne volumev3 admin 'http://10.0.0.11:8776/v3/%(project_id)s'
