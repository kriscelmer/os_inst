...
openstack endpoint create --region RegionOne orchestration public 'http://10.0.0.11:8004/v1/%(tenant_id)s'
...
openstack endpoint create --region RegionOne cloudformation public http://10.0.0.11:8000/v1
openstack endpoint create --region RegionOne cloudformation internal http://10.0.0.11:8000/v1
openstack endpoint create --region RegionOne cloudformation admin http://10.0.0.11:8000/v1
