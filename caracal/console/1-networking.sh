...
sudo cp os_inst/caracal/hosts /etc/hosts
...
echo "openstack" | ssh openstack@controller sudo -S bash /home/openstack/os_inst/caracal/controller/1-networking.sh
...
echo "openstack" | ssh openstack@compute1 sudo -S bash /home/openstack/os_inst/caracal/compute1/1-networking.sh
...
echo "openstack" | ssh openstack@compute2 sudo -S bash /home/openstack/os_inst/caracal/compute2/1-networking.sh
...
echo "openstack" | ssh openstack@storage1 sudo -S bash /home/openstack/os_inst/caracal/storage1/1-networking.sh
...
echo "openstack" | ssh openstack@storage2 sudo -S bash /home/openstack/os_inst/caracal/storage2/1-networking.sh
...
sudo cp os_inst/caracal/console/interfaces /etc/network/interfaces
