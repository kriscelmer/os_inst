...
echo "openstack" | ssh openstack@controller sudo -S bash /home/openstack/os_inst/xena/controller/1-networking.sh
...
echo "openstack" | ssh openstack@compute1 sudo -S bash /home/openstack/os_inst/xena/compute1/1-networking.sh
...
echo "openstack" | ssh openstack@compute2 sudo -S bash /home/openstack/os_inst/xena/compute2/1-networking.sh
...
echo "openstack" | ssh openstack@storage1 sudo -S bash /home/openstack/os_inst/xena/storage1/1-networking.sh
...
echo "openstack" | ssh openstack@storage2 sudo -S bash /home/openstack/os_inst/xena/storage2/1-networking.sh
